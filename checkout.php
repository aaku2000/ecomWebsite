					...
					<div class="billing-details">
						...
						<div class="space30"></div>
							...
							<select name="country" class="form-control">
								...
								<option value="BB">China</option>
								<option value="BB">South Korea</option>
								<option value="BB">Nepal</option>
								<option value="BB">India</option>
								<option value="BB">Italy</option>
								<option value="BB">Pakistan</option>
								<option value="BB">London</option>
								<option value="BB">France</option>
							</select>
		...
		<?php 
			...
			<div class="payment-method">
				<div class="row">
						...
						<div class="col-md-4">
							<input name="payment" id="radio2" class="css-checkbox" type="radio"><span value="Debit Card Payment">Debit Card Payment</span>
							<div class="space20"></div>
							<p>Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order won't be shipped until the funds have cleared in our account.</p>
						</div>
						<div class="col-md-4">
							<input name="payment" id="radio3" class="css-checkbox" type="radio"><span value="Esewa">ESEWA</span>
							<div class="space20"></div>
