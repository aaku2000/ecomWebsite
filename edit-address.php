...
if(isset($_POST) & !empty($_POST)){
		...
		$usql = "UPDATE usersmeta SET country='$country', firstname='$fname', lastname='$lname',city='$city',  address1='$address1', address2='$address2', mobile='$phone' WHERE uid=$uid";
	...
	<section id="content">
		<div class="content-blog">
					<div class="page_header text-center">
						<h2>Shop - Checkout</h2>
						<p>Get  Best Product At Resonable Price With Us</p>
					</div>
<form method="post">
<div class="container">
			<div class="row">
